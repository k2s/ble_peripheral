...
class BlePeripheralChannel {
  ...
  Future<void> setBondingEnabled(bool enabled) async {
    final String pigeonVar_channelName =
        'dev.flutter.pigeon.ble_peripheral.BlePeripheralChannel.setBondingEnabled$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel =
        BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
